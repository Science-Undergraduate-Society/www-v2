...
export default function CouncilAndProcedures() {
    return (
        <div className={styles.councilAndProcedures}>
            <BannerHeader>
            ...
            <BannerSection className={styles.councilMeetings}>
                ...
                <p>
                    Council meetings are held <b>monthly</b>.
                    Our next council meeting will be February 12th, 2026 and March 12th, 2026 from 5 - 7pm in the Micheal Kingsmill Forum.
                    <br /><br />
            ...
            <section className={styles.whoCanVote}>
                <h1>Who Can Vote?</h1>
                <p>
                    Voting members of council include the SUS Executives (President and Vice-Presidents), and elected councilors from each department/program.
                    Non-voting members include the Speaker of Council, AVP Administrations (as Clerks of Council), AMS Representatives, the Science Senator, and the representatives from SUS Program Clubs.
                </p>
            </section>
            <section className={styles.councilors}>
                <h1>Councilors</h1>
                <p>
